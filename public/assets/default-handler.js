...
!function(t) {
    ...
    function o() {
        ...
        new Promise(function(t, r) {
                ...
                a() && e.push(ResourceLoader.loadScript(n + "/apps/fc3/build/spsbuster-libs.js")),
                s.length > 0 && e.push(ResourceLoader.loadCss(n + "/apps/fc3/build/form-animations.css?1680250029423")),
                    e.push(ResourceLoader.loadScript("//cdnjs.cloudflare.com/ajax/libs/mobile-detect/1.3.6/mobile-detect.min.js")),
                    e.push(ResourceLoader.loadCss(n + "/apps/fc3/build/form-defaults.css?1680250029423")),
...
SPForm.prototype.init = function() {
    ...
    SPForm.prototype.cbSubmit = function(t) {
        var e = this;
        t.hasOwnProperty("html") && t.hasOwnProperty("status") && (e.$form.find(".sp-element-container").hide(),
            "success" === t.status ? (e.$formMessage.addClass("sp-message-success"),
                e.sent = !0,
                e.history.addSubmit(),
            ...
            void 0 !== e.showOptions.submitRedirectUrl && e.showOptions.submitRedirectUrl.length > 0 && (window.location = e.showOptions.submitRedirectUrl)) : "verify" === t.status ? (e.sent = !0,
                e.history.addSubmit(),
                e.enableInputs(),
                e.statAgent.sendAnalyticsEvent(e.showOptions.analytics),
                e.close(),
                window.location.href = "//" + e.showOptions.maDomain + "/forms/recaptcha?hash=" + t.form_hash) : (e.$formMessage.addClass("sp-message-error"),
                e.$formMessage.html(t.html),
                e.enableInputs(),
            ...
            e.$submitButton.addClass("btn-loading"),
                ...
                function() {
                    ...
                    "(none)" !== sbjs.get.first.trm && (e.preparedData["sform[" + window.btoa("visitFirstUtmTerm") + "]"] = sbjs.get.first.trm),
                        e.preparedData["sform[" + window.btoa("visitSubscribeType") + "]"] = sbjs.get.current.typ,
                        "(direct)" === sbjs.get.current.src ? e.preparedData["sform[" + window.btoa("visitSubscribeSource") + "]"] = sbjs.get.current.src.substring(1, sbjs.get.current.src.length - 1) : e.preparedData["sform[" + window.btoa("visitSubscribeSource") + "]"] = sbjs.get.current.src,
                    "(none)" !== sbjs.get.current.mdm && (e.preparedData["sform[" + window.btoa("visitSubscribeMedium") + "]"] = sbjs.get.current.mdm),
                    "(none)" !== sbjs.get.current.cmp && (e.preparedData["sform[" + window.btoa("visitSubscribeCampaign") + "]"] = sbjs.get.current.cmp),
                    "(none)" !== sbjs.get.current.cnt && (e.preparedData["sform[" + window.btoa("visitSubscribeContent") + "]"] = sbjs.get.current.cnt),
                    "(none)" !== sbjs.get.current.trm && (e.preparedData["sform[" + window.btoa("visitSubscribeTerm") + "]"] = sbjs.get.current.trm))
                }(),
                function() {
                    jQ.ajax({
    ...
    SPStatAgent.prototype.sendAnalyticsEvent = function(t) {
        ...
        t.ym && t.ym.send && (console.log("Yandex.Metrica Counter", window["yaCounter" + t.ym.counterId]),
        void 0 !== t.ym.counterId && void 0 !== t.ym.targetId && void 0 !== window.ym && window.ym(t.ym.counterId, "reachGoal", t.ym.targetId)))
    }
    ,
